...
const Home = () => {
    ...
    <>
      <div className="hero_section parent">
        ...
        <div className="hero_left">
          ...
          <p>
            Quality auto repair wordpress Theme in Envato Market.
            We offer a varity of custom services.
          </p>
        ...
        <div className="hero_right">
          ...
          <p>
            Fill out the from below and we'll get back to you soon.
          </p>
          <form>
  ...
  <div className="about_cont cont">
    ...
    <div className="top_content">
      ...
      <div className="box">
        <span><FaCarBattery /></span>
        <h3>Batteries</h3>
        <p>It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures.</p>
      </div>
      <div className="box">
        <span><TbSettingsBolt /></span>
        <h3>Breaks</h3>
        <p>It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures.</p>
      </div>
    </div>
    <div className="top_content">
      <div className="box">
        <span><PiEngineBold /></span>
        <h3>Engine Repair</h3>
        <p>It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures.</p>
      </div>
      <div className="box">
        <span><GiFlatTire /></span>
